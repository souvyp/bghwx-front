  ...
  <div class="financing-apply">
  	<yd-cell-group>
	  	...
	  	<div class="page-actionsheet">
			<ul class="tab-ul">
	      		<li v-for="oneList in oneLists" :key="oneList.one" class="tab-ul-li tab-ul-li-list" @click="handleSee">
					<div class="financing-list">
						...
						<div>
							<div class="color-grey"><icon name="applyFinanice" scale="2.5" class="icon-finanice"></icon><span>申请金额</span></div>
							<div class="price"><span>￥4,000,000</span></div>
						</div>
						<div>
							<div class="text">
								<div class="color-grey"><span>放款金额</span></div>
								<div><span class="color-green">￥3,999,750</span></div>
							</div>
							<div class="text">
