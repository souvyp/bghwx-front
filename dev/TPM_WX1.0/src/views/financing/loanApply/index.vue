  ...
  <div class="financing-apply">
  	<yd-cell-group>
	  	...
	  	<div class="page-actionsheet">
			<ul class="tab-ul">
	      		<li v-for="oneList in oneLists" :key="oneList.one" class="tab-ul-li tab-ul-li-list" @click="applyFinaning">
					<div class="financing-list">
						...
						<div>
							<div class="color-grey"><icon name="applyFinanice" scale="2.5" class="icon-finanice"></icon><span>融资额度</span></div>
